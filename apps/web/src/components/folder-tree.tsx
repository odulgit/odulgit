                                ...
                                <AccordionPrimitive.Item value={item.id}>
                                    <AccordionTrigger
                                        className={cn(
                                            ...
                                            selectedItemId === item.id && "dark:before:border-0 text-purple-400"
                                        )}
...
>(({ className, item, isSelected, Icon, ...props }, ref) => {
    return (
        ...
        hover:before:opacity-100 before:absolute before:left-0 before:right-1 before:w-full before:opacity-0 before:bg-muted/80 before:h-[1.75rem] before:-z-10",
                className,
                isSelected && "before:opacity-100 before:text-accent-foreground before:border-l-2 before:border-l-accent-foreground/50 dark:text-purple-400 before:border-0"
            )}
            {...props}
        >
