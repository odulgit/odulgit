...
contract DealClient {
    ...
    mapping(bytes => RequestIdd) public pieceRequests; // commP -> dealProposalID
    ...
    function getProposalIdSet(
        bytes calldata cid
    ) public view returns (RequestIdd memory) {
    ...
    function makeDealProposal(
        ...
        pieceRequests[deal.piece_cid] = RequestIdd(id, true);
